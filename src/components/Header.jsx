...
function Header() {
  return (
    ...
    <div className='md:w-10/12 text-center p-0 bg-light-blue-color w-2/5 mx-auto rounded-sm lg:hover:w-3/5 duration-300'>
      <h2 className='hover:brightness-200 xl:hover:text-3xl lg:hover:text-xl duration-300 text-green-color xl:text-2xl md:text-1xl'>EL UNIVERSO PARA TU VEHICULO</h2>
    </div>
    </div>
  )
}
